    ...
    <IonPage>
      ...
      <IonContent fullscreen>
        <div className="px-5 mt-7 mb-7 ">
          <p className="font-urbanist font-medium text-sm leading-5 text-[#7F8489]">
          ...
          <div className="mt-3 p-4 space-y-5 ">
            {languages?.map((lang, i) => (
              <div
                key={i}
                className="inline-flex items-center justify-between w-full pb-3 border-b-black border-b-[1px]"
              >
                <p>{lang}</p>
